(function () {
  ...
  var imagesData = {
    ...
    Ribbon: {
      Main: {
        "Red 1 BG White": { img: "./assets/ribbon_main/ribbon_main_red_white_21_9.png", lock: true, data: AR2 },
        "Red 1 BG Red 4": { img: "./assets/ribbon_main/ribbon_main_red_21_9.png", lock: true, data: AR2 },
        "Blue 1 BG White": { img: "./assets/ribbon_main/ribbon_main_blue_white_21_9.png", lock: true, data: AR2 },
        "Blue 1 BG Blue 4": { img: "./assets/ribbon_main/ribbon_main_blue_21_9.png", lock: true, data: AR2 },
        "Teal 1 BG White": { img: "./assets/ribbon_main/ribbon_main_teal_white_21_9.png", lock: true, data: AR2 },
        "Teal 1 BG Teal 4": { img: "./assets/ribbon_main/ribbon_main_teal_21_9.png", lock: true, data: AR2 },
        "Salmon 1 BG White": { img: "./assets/ribbon_main/ribbon_main_salmon_white_21_9.png", lock: true, data: AR2 },
        "Salmon 1 BG Salmon 4": { img: "./assets/ribbon_main/ribbon_main_salmon_21_9.png", lock: true, data: AR2 },
        "Orange 1 BG White": { img: "./assets/ribbon_main/ribbon_main_orange_white_21_9.png", lock: true, data: AR2 },
        "Orange 1 BG Orange 4": { img: "./assets/ribbon_main/ribbon_main_orange_21_9.png", lock: true, data: AR2 },
        "Purple 1 BG White": { img: "./assets/ribbon_main/ribbon_main_purple_white_21_9.png", lock: true, data: AR2 },
        "Purple 1 BG Purple 4": { img: "./assets/ribbon_main/ribbon_main_purple_21_9.png", lock: true, data: AR2 },
        "Fuchsia 1 BG White": { img: "./assets/ribbon_main/ribbon_main_fuchsia_white_21_9.png", lock: true, data: AR2 },
        "Fuchsia 1 BG Fuchsia 4": { img: "./assets/ribbon_main/ribbon_main_fuchsia_21_9.png", lock: true, data: AR2 },
        "Green 1 BG White": { img: "./assets/ribbon_main/ribbon_main_green_white_21_9.png", lock: true, data: AR2 },
        "Green 1 BG Green 4": { img: "./assets/ribbon_main/ribbon_main_green_21_9.png", lock: true, data: AR2 },
        "Aqua 1 BG White": { img: "./assets/ribbon_main/ribbon_main_aqua_white_21_9.png", lock: true, data: AR2 },
        "Aqua 1 BG Aqua 4": { img: "./assets/ribbon_main/ribbon_main_aqua_21_9.png", lock: true, data: AR2 },
      },
    },
    "3D": {
      Fluid: {
